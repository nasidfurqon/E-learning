...
<div class="card-wrap mt-4">
    ...
    <div class="card rounded-start rounded-end">
        ...
        <div class="card-img-overlay d-flex">
            ...
            <div class="title">
                <h5 class="card-title fs-6"><a href="/index.php?page=detail-mtr" class="text-decoration-none text-black">User memposting materi baru: </a></h5>
                <p class="updated card-text text-black-50">Last updated 3 mins ago</p>
            </div>
        </div>
    </div>
